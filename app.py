...
frame_skip = 4
seconds_per_input = 5
is_advancing = False _initial_gif_io = BytesIO()
...
def next_frame(frame): 
     ...
     gif_bytes = BytesIO()
     img, *imgs = frames 
     img.save(gif_bytes, format='GIF', save_all=True, append_images=imgs, duration=1000 * seconds_per_input // len(frames), optimize=True)
